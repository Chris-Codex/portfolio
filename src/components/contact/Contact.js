    ...
    return (
        ...
        >
            ...
            <div className="w-full">
                <div className="w-full h-auto flex flex-col lgl:flex-row justify-between gap-20">
                    <ContactLeft />
                        ...
                        <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <textarea
                                    ...
                                    value={message}
                                    className={`${errMsg === "Message is required!" && "outline-[#ea3948]"
                                        } contactTextArea`}
                                    cols="30"
                                    rows="8"
                                ></textarea>
                            ...
                            <div className="w-full">
                                <button
                                    onClick={handleSend}
                                    className="w-full h-12 bg-[#141518] rounded-lg text-base text-gray-400 tracking-wider uppercase hover:text-white duration-300 hover:border-[1px] hover:border-[#7aea39] border-transparent"
                                >
                                    Send Message
                                </button>
                            </div>
